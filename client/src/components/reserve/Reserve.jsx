...
const Reserve = ({ setOpen, hotelId }) => {
  ...
  const isAvailable = (roomNumber) => {
    const isFound = roomNumber.unavailableDates.some((dates) =>
      {
        ...
        {
          var date = dates[i];
          _isFound = alldates.includes(new Date(date).getTime());
          if(_isFound)
          {
            break;
          }
    ...
    // const isFound = roomNumber.unavailableDates.flatMap(i => i[0]).some((date) =>
    //   alldates.includes(new Date(date).getTime())
    // );
    return !isFound;
  };
          ...
          <div className="rItem" key={item._id}>
            ...
            <div className="rSelectRooms">
              ...
              {item.roomNumbers.map((roomNumber) => (
                  console.log("tét",!isAvailable(roomNumber)),
                <div className="room">
